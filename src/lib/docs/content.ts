...
export const docSections: DocSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "4. Approve — explicit disclosure, SoDEX testnet order IDs in execution stepper",
      "5. Dashboard (/dashboard/[slug]) — refresh intelligence, propose rebalance, weekly memo",
